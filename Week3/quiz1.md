...
- 답: 1번은 A, B, C의 커밋이 그대로 main 브랜치로 병합하는 기능 
      2번은 여러개의 commit을 하나의 commit으로 합치는 기능
      3번은 main branch의 최신 commit으로 base를 변경하는 기능
...
- 답: revert, 다른 사람이 작업 하고 있는 브랜치에서 reset을 사용할 경우 다른 사람이 올린 commit이 삭제될 수 있기 때문이다.
